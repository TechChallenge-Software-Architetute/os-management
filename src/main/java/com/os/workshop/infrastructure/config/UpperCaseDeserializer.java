...
public class UpperCaseDeserializer extends JsonDeserializer<String> implements ContextualDeserializer {
    ...
    public UpperCaseDeserializer() { this.enabled = false; }
    public UpperCaseDeserializer(boolean enabled) { this.enabled = enabled; }
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) {
        if (property != null && property.getAnnotation(UpperCase.class) != null) {
