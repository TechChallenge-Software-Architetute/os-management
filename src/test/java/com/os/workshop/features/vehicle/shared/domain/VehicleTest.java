...
class VehicleTest {
    ...
    void whenCreatingVehicleWithNullClientId_thenThrowsNullPointer() {
        assertThrows(NullPointerException.class,
                () -> Vehicle.create(null, "ABC1234", "Toyota", "Corolla", 2020, "White", VehicleType.CAR));
    }

    @Test
    void whenCreatingVehicleWithBlankBrand_thenThrowsIllegalArgument() {
        assertThrows(IllegalArgumentException.class,
                () -> Vehicle.create(1L, "ABC1234", " ", "Corolla", 2020, "White", VehicleType.CAR));
    }

    @Test
    void whenCreatingVehicleWithBlankModel_thenThrowsIllegalArgument() {
        assertThrows(IllegalArgumentException.class,
                () -> Vehicle.create(1L, "ABC1234", "Toyota", " ", 2020, "White", VehicleType.CAR));
    }

    @Test
    void whenCreatingVehicleWithYearBelow1886_thenThrowsIllegalArgument() {
        assertThrows(IllegalArgumentException.class,
                () -> Vehicle.create(1L, "ABC1234", "Toyota", "Corolla", 1885, "White", VehicleType.CAR));
    }

    @Test
    void whenUpdatingVehicle_thenFieldsAreUpdated() {
        Vehicle vehicle = Vehicle.create(1L, "ABC1234", "Toyota", "Corolla", 2020, "White", VehicleType.CAR);
