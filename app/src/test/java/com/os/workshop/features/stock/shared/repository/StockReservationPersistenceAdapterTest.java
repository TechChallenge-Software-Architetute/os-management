...
import com.os.workshop.features.stock.shared.mapper.StockReservationMapper;
...
class StockReservationPersistenceAdapterTest {
    ...
    @Mock private StockReservationJpaRepository jpaRepository;
    @Mock private StockReservationMapper mapper;
    @InjectMocks private StockReservationPersistenceAdapter adapter;
