...
@Schema(description = "Find Part By Sku response payload.")
public record FindPartBySkuResponse(
    ...
    public static FindPartBySkuResponse from(Part part) {
        return new FindPartBySkuResponse(
